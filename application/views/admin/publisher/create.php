...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo site_url('main-category'); ?>">Publishers</a></li>
            ...
            <div class="col-lg-12">
                <div class="card recent-sales overflow-auto">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="post" action="<?php echo base_url('publisher/store'); ?>">
                            <div class="row mb-3">
                                <label for="publisher" class="col-sm-2 col-form-label">Publisher</label>
                                <div class="col-sm-10">
                                    <input id="publisher" name="publisher" type="text" class="form-control" placeholder="Enter Publisher" required>
                                </div>
                            </div>
