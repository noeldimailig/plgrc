        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card recent-sales overflow-auto">
                    <div class="card-body">
                        <h5 class="card-title">Add Borrower</h5>

                        <form class="needs-validation" novalidate method="post" action="<?php echo base_url('borrowers/store'); ?>">
                            <div class="row mb-3">
                                <label for="name" class="col-sm-2 col-form-label">Fullname</label>
                                <div class="col-sm-10">
                                    <input id="name" name="name" type="text" class="form-control" placeholder="Enter fullname" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="office" class="col-sm-2 col-form-label">Office</label>
                                <div class="col-sm-10">
                                    <input id="office" name="office" type="text" class="form-control" placeholder="Enter office">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="phone" name="phone" type="text" class="form-control" placeholder="09XXXXXXXXX" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="purpose" name="purpose" type="text" class="form-control" placeholder="Enter purpose" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="date-borrowed" name="date-borrowed" type="date" class="form-control" required>
                                </div>
                            </div>
